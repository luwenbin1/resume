		...
		$.ajax({
			...
			success:function(res){
				if(res){
					...
					$('#showlist').html(' ');
					for(i in obj){
						var newhtml=$('<div class="list_m"><div class=""><span>'+obj[i].ip.substring(0,obj[i].ip.lastIndexOf('.'))+'.***</span></div><div class=""><span title="'+obj[i].sys+'">'+obj[i].sys+'</span></div><div class=""><span>'+obj[i].width+'*'+obj[i].height+'</span></div><div class=""><span>'+obj[i].position+'</span></div><div class=""><span>'+obj[i].datatime+'</span></div></div>');
